...
import com.documentos.wms_beirario.databinding.ActivityBluetoohBinding
...
open class BluetoohActivity : AppCompatActivity() {

    private lateinit var mBinding: ActivityBluetoohBinding
    ...
    private fun setupRecyclerView() {
        ...
        mBinding.rvListDevicesBluetooh.apply {
            layoutManager = LinearLayoutManager(this@BluetoohActivity)
            adapter = mAdapter
        }
    }
...
//            printerConnection.printZebra(null, com.documentos.wms_beirario.ui.configuracoes.SetupNamePrinter.applicationPrinterAddress)
            mBluetoothAdapter!!.cancelDiscovery()
            mAdapter!!.clear()
            device.createBond()
            printerValidad()
