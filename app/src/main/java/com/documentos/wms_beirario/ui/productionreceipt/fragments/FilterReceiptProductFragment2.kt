...
class FilterReceiptProductFragment2 : Fragment() {
    ...
    /**SET ADAPTER E CLICK NO ITEM PARA FINALIZAR--->*/
    private fun setRecyclerView() {
        mAdapter = AdapterReceiptProduct1 { itemClick ->
            val action = FilterReceiptProductFragment2Directions.clickFinish(itemClick,true)
    ...
    private fun setupTxtInformation() {
     mBinding!!.txtInfOperator22.text = getString(R.string.Pendence_operator,mArgs.operatorSelect.usuario)
    }
